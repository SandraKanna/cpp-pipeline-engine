...
TIDY_SRC = src/bytes.cpp src/data_model.cpp src/acquisition/buffer_acquisition.cpp src/acquisition/file_acquisition.cpp \
		   ...
		   src/serialization/raw_serialization.cpp src/delivery/buffer_delivery.cpp src/engine.cpp \
		   tests/data_model_test.cpp tests/buffer_acquisition_test.cpp tests/file_acquisition_test.cpp \
		   tests/line_delimitation_test.cpp tests/raw_parsing_test.cpp tests/raw_serialization_test.cpp \
		   tests/buffer_delivery_test.cpp tests/engine_test.cpp
